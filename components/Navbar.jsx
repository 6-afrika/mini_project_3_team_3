        ...
        text-white'>
                ...
                <div>
                    <ul className='mr-20 hidden md:flex text-white'>
                        ...
                        <Link href='/'>
                            <li className='ml-10 text-sm uppercase hover:border-b'>City Weather</li>
                        </Link>
                        <Link href='/'>
                            <li className='ml-10 text-sm uppercase hover:border-b'>Hourly Weather</li>
                        </Link><Link href='/'>
                    ...
                    <div className='mt-[10px] ml-[20px] mr-[10px]'>
                        <div className='flex w-full items-center justify-between '>
                            <span className=' flex  items-center justify-center w-10 h-10 bg-white rounded-full'>
                                <WiDayFog className="inline-block w-8 h-8 bg-transparent rounded-full text-black" />
